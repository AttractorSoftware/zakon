...
от 17 октября 2008 года N 230""", builder.build_place_and_date())
    ...
    def test_build_empty_sections_must_raise_error(self):
        ...
        self.assertEqual('exception handled', result)
        self.assertTrue(isinstance(ex, ParserError))
        self.assertEqual(u'Ошиибка! "Статья 2. Государственный орган, осуществляющий регистрацию" пустая!', ex[0])
        ...
        self.assertEqual('exception handled', result)
        self.assertTrue(isinstance(ex, ParserError))
        self.assertEqual(u'Ошиибка! "Глава 1 Общие положения" пустая!', ex[0])
        ...
        self.assertEqual('exception handled', result)
        self.assertTrue(isinstance(ex, ParserError))
        self.assertEqual(u'Ошиибка! "Подраздел 1. Я подраздел 1" пустая!', ex[0])
        ...
        self.assertEqual('exception handled', result)
        self.assertTrue(isinstance(ex, ParserError))
        self.assertEqual(u'Ошиибка! "РАЗДЕЛ I ОБЩИЕ ПОЛОЖЕНИЕ" пустая!', ex[0])
        ...
        self.assertEqual('exception handled', result)
        self.assertTrue(isinstance(ex, ParserError))
        self.assertEqual(u'Ошиибка! "ОБЩАЯ ЧАСТЬ" пустая!', ex[0])
