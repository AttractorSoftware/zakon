...
Сценарий: Пользователь попадает на страницу откуда ссылается после подтверждения
...
Сценарий: Документ содержит ссылку в статье после добавления
...
Сценарий: Ссылаемый документ содержит ссылку
    Допустим я нахожусь на странице "ЗАКОН КЫРГЫЗСКОЙ РЕСПУБЛИКИ О государственной регистрации юридических лиц, филиалов (представительств)"
